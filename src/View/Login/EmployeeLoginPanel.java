 ...
 * @author vinic
 */
public class EmployeeLoginPanel extends javax.swing.JFrame {
    ...
    private void initComponents() {
     ...
     private boolean LoginEmployee(Employee employee) throws SQLException {
    ...
    private void jButtonEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEntrarActionPerformed
        try {
            boolean  exists = LoginEmployee(employee);
    ...
    private void jButtonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrarActionPerformed
        EmployeeRegisterPanel obj = new EmployeeRegisterPanel();
        obj.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmployeeLoginPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmployeeLoginPanel().setVisible(true);
            }
        });
    }
